/* The following code was generated by JFlex 1.4.3 on 12/5/09 6:17 PM */
 ...
 * on 12/5/09 6:17 PM from the specification file
 * <tt>tiny.flex</tt>
 */
class TINYLexer {
   /*
...
public boolean isZzAtEOF() {
  ...
  private static final String ZZ_CMAP_PACKED = 
    ...
    "\1\7\1\35\2\0\1\30\1\31\1\34\1\27\1\33\1\11\2\0"+
    "\1\10\11\5\1\25\1\32\1\0\1\26\3\0\32\4\4\0\1\6"+
    "\1\0\1\22\1\13\1\4\1\20\1\14\1\4\1\15\1\4\1\16"+
    "\4\4\1\17\1\4\1\23\1\4\1\21\1\4\1\24\6\4\1\0"+
    "\1\12\2\0\41\7\2\0\4\7\4\0\1\7\2\0\1\7\7\0"+
  ...
  private static final String ZZ_ROWMAP_PACKED_0 =
    ...
    "\0\264\0\322\0\360\0\u010e\0\u012c\0\u014a\0\264\0\74"+
    "\0\74\0\74\0\74\0\74\0\74\0\u0168\0\u0186\0\u01a4"+
    "\0\u01c2\0\74\0\u01e0\0\132\0\u01fe\0\u021c\0\u023a\0\132"+
    "\0\u0258\0\132\0\132";
  ...
  private static final String ZZ_TRANS_PACKED_0 =
    ...
    "\1\10\1\11\1\12\1\13\4\4\1\14\1\4\1\15"+
    "\1\4\1\16\1\0\1\17\1\20\1\21\1\22\1\23"+
    "\1\24\1\25\2\0\1\3\75\0\5\4\1\0\13\4"+
    "\16\0\1\5\2\0\1\5\31\0\2\4\2\0\1\4"+
    "\2\0\12\4\16\0\1\5\2\0\1\7\2\11\14\0"+
    "\1\11\12\0\5\4\1\0\2\4\1\26\10\4\15\0"+
    "\5\4\1\0\5\4\1\27\5\4\15\0\5\4\1\0"+
    "\2\4\1\30\10\4\15\0\5\4\1\0\7\4\1\31"+
    "\3\4\37\0\1\32\13\0\5\4\1\0\3\4\1\33"+
    "\7\4\15\0\5\4\1\0\6\4\1\34\4\4\15\0"+
    "\5\4\1\0\10\4\1\35\2\4\15\0\5\4\1\0"+
    "\4\4\1\36\6\4\15\0\5\4\1\0\4\4\1\37"+
    "\6\4\15\0\5\4\1\0\6\4\1\40\4\4\15\0"+
    "\5\4\1\0\5\4\1\41\5\4\15\0\5\4\1\0"+
    "\5\4\1\42\5\4\15\0\5\4\1\0\12\4\1\43"+
    "\11\0";
    ...
    while (true) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        case 2: 
          ...
          System.out.println("action [66] { return \"ID\"; }");
          { return "ID";
          }
        case 17: break;
        case 9: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [79] { return \"COMMA\"; }");
          { return "COMMA";
          }
        case 18: break;
        case 16: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [64] { return \"PRINT\"; }");
          { return "PRINT";
          }
        case 19: break;
        case 1: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [85] { /* ignore */ }");
          { /* ignore */
          }
        case 20: break;
        case 4: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [75] { return \"MINUS\"; }");
          { return "MINUS";
          }
        case 21: break;
        case 7: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [77] { return \"RIGHTPAR\"; }");
          { return "RIGHTPAR";
          }
        case 22: break;
        case 5: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [74] { return \"PLUS\"; }");
          { return "PLUS";
          }
        case 23: break;
        case 6: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [76] { return \"LEFTPAR\"; }");
          { return "LEFTPAR";
          }
        case 24: break;
        case 8: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [78] { return \"SEMICOLON\"; }");
          { return "SEMICOLON";
          }
        case 25: break;
        case 14: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [63] { return \"READ\"; }");
          { return "READ";
          }
        case 26: break;
        case 12: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [72] { return \"ASSIGN\"; }");
          { return "ASSIGN";
          }
        case 27: break;
        case 3: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [69] { return \"INTNUM\"; }");
          { return "INTNUM";
          }
        case 28: break;
        case 11: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [81] { return \"PERCENT\"; }");
          { return "PERCENT";
          }
        case 29: break;
        case 10: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [80] { return \"STAR\"; }");
          { return "STAR";
          }
        case 30: break;
        case 15: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [61] { return \"BEGIN\"; }");
          { return "BEGIN";
          }
        case 31: break;
        case 13: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [62] { return \"END\"; }");
          { return "END";
          }
        case 32: break;
        default: 
